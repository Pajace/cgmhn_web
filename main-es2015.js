...
const routes = [
    ...
    { path: 'menu', loadChildren: () => __webpack_require__.e(/*! import() | pages-menu-menu-module */ "pages-menu-menu-module").then(__webpack_require__.bind(null, /*! ./pages/menu/menu.module */ "./src/app/pages/menu/menu.module.ts")).then(m => m.MenuPageModule) },
];
...
module.exports = __webpack_require__(/*! D:\workspace\hera2\src\main.ts */"./src/main.ts");
